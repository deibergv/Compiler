...
/* Una literal entera es un numero 0 o un digito del 1 al 9
    seguido de 0 o mas digitos del 0 al 9 */
EXP_Entero = 0 | [1-9][0-9]*
EXP_Texto=[A-Za-z]
EXP_TextoYEstero={EXP_Texto}|{EXP_Entero}
...
<YYINITIAL> {
    ...
    {EXP_Entero}      {   System.out.print(yytext());
                      return symbol(sym.EXP_Entero, new Integer(yytext())); }
